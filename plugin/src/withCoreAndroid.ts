...
const withCoreMainApplication: ConfigPlugin<SdkConfigurationProps> = (config, {
    ...
    return withMainApplication(config, (config) => {
        ...
        mainApplication = mainApplication.replace(/import android.app.Application;/, `${imports}\nimport android.app.Application;`);
...
export const withCoreAndroidSdk: ConfigPlugin<SdkConfigurationProps> = (
    config,
    props,
  ) => {
